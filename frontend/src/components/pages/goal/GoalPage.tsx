      ...
      <div style={{maxWidth: '400px', width: '100%'}}>
        ...
        <Form
          ...
          <Form.Item
            ...
            name="type"
            rules={[
              {required: true, message: 'Please select your goal type!'},
            ]}>
            <Select>
          ...
          <Form.Item
            ...
            name="frequency"
            rules={[
              {required: true, message: 'Please select your goal frequency!'},
            ]}>
            <Select>
          ...
          <Form.Item
            ...
            name="value"
            rules={[
              {required: true, message: 'Please enter your goal value!'},
            ]}>
            <InputNumber
              min={1}
        ...
        {goal.value > 0 && (
          <Text
            ...
            Current Goal:{' '}
            <strong>
              {goal.value} {goal.type} ({goal.frequency})
            </strong>
          </Text>
        )}
      </div>
